                            ...
                            <div class="card" >
                                ...
                                <div class="card-footer">
                                    <div class="text-right">
                                        <button id="addTypeBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add Department</button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9">
                                                <div class="form-group">
                                                    <label for="inputTime" >Department Name</label>
        ...
        <script>
            ...
            document.getElementById('saveBtn').addEventListener('click', function () {
                ...
                if ($('#department').val().trim() === '') {
                    Swal.fire("Empty Department!", "Please Enter a Valid Department!", "warning");
                    return;
                }
                ...
                if (mode === 'save') {
                    ...
                    fetch('department/saves', {
                        ...
                        Swal.fire('Successful!', 'Department has been successfully saved', 'success');
                        clearForm();
                        $('#formSection').hide();
                        $('#tableSection').fadeIn();
                        dtable.ajax.reload();
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status === 200) {
                                Swal.fire('Successful!', 'Department details updated successfully', 'success');
                                clearForm();
                                $('#formSection').hide();
                                $('#tableSection').fadeIn();
                                dtable.ajax.reload();
            ...
            $(document).on('click', '.delrec', function () {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return fetch('department/deactivate-department', {
                            method: 'POST',
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'Department has been Deactivated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
            ...
            $(document).on('click', '.rerec', function () {
                ...
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('department/reactivate-department', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
                    ...
                    if (result.value) {
                        if (result.value.status !== 200) {
                            ...
                            Swal.fire('Successfull!', 'Department has been Activated !', 'success');
                            dtable.ajax.reload();
                            $('#formSection').hide();
                            $('#tableSection').fadeIn();
                        }
