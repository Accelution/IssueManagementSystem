    ...
    <body>
        ...
        <main class="main" id="top">
            <div class="container-fluid" data-layout="container">
                ...
                <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card" id="tableCard">
                                            <div class="card-body" >
                                                <h5 id="main_name_tag">Ticket Management System - In Progress</h5>
                                                <hr>
                    ...
                    <!--formSection-queue-->
                    <div class="" id="formSectionInp" style="display: none; padding-top: 1rem;">
        ...
        <script>
            ...
            closeBtnin.addEventListener('click', function () {
                formSectionInp.style.display = 'none';
